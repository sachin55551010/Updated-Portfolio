...
export const ToolsSection = () => {
  return (
    <>
      {/* title */}
      <div className="w-fit">
        <h4 className={`font-bold text-xl ${audiowide.className}`}>Tools</h4>
      ...
      <div className="border border-primary-text/15 rounded-2xl p-4 grid grid-cols-4 lg:grid-cols-5 gap-5 place-items-center backdrop-blur-[.15rem] mt-6">
